...
namespace TheQ.Libraries.AzureTools.AutoQueue.Standard
{
    ...
    public class SimpleAutoQueueFactory : AutoQueueFactory
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="SimpleAutoQueueFactory" /> class.
        /// </summary>
        public SimpleAutoQueueFactory() : base(new SimpleRetryPolicy(10, true, new LinearRetryStrategy(TimeSpan.FromSeconds(1), TimeSpan.FromSeconds(0.9))), new BsonSerializer())
        {
        }
    }
}